...
Dll_PPDll float GJMdet;   //雅可比行列式值
Dll_PPDll int SinguStateflag;
/************************************初始参数设置*********************************/
/////////////杆件基本尺寸//////////////////
...
Dll_PPDll void JGJN_Static_7(double qm[8], double Jm[6][7]);
...
Dll_PPDll void PseudoInverse(double J[6][7], double PJ[7][6]);
